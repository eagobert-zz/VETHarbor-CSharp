...
namespace VETHarbor.Migrations
{
    ...
    [Migration("20180327211955_UpdateIndexViewModel")]
    partial class UpdateIndexViewModel
    {
            ...
            modelBuilder.Entity("VETHarbor.Models.Events", b =>
                {
                    ...
                    b.Property<int?>("UserEventsUserEventId");

                    b.HasKey("EventId");

                    b.HasIndex("OrgId");

                    b.HasIndex("UserEventsUserEventId");
            ...
            modelBuilder.Entity("VETHarbor.Models.Events", b =>
                {
                    ...
                    b.HasOne("VETHarbor.Models.UserEvents")
                        .WithMany("Event")
                        .HasForeignKey("UserEventsUserEventId");
                });
